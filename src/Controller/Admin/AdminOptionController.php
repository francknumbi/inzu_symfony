...
class AdminOptionController extends AbstractController
{
    ...
    #[Route('admin/edit/{id}', name: 'admin.option.edit', methods: ['GET', 'POST'])]
    ...
    #[Route('admin/delete/{id}', name: 'admin.option.delete', methods: ['DELETE'])]
    public function delete(Request $request, Option $option): Response
    {
        ...
        return $this->redirectToRoute('/admin/option_index', [], Response::HTTP_SEE_OTHER);
    }
}
